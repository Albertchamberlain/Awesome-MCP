...
- [PostEverywhere](https://github.com/posteverywhere/mcp) ✅ `stdio` `http` — Schedule and publish social posts to 11 platforms with media, campaigns, analytics and AI captions. — `social`, `marketing`
